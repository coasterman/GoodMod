...
*/
class GoodModWeaponAttachment_Hatchet extends AOCWeaponAttachment_Hatchet;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'GoodModWeapon_Hatchet'

	WeaponSocket = wep1hpoint

	AttackTypeInfo(0)=(fBaseDamage=95.0, fForce=20000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=95.0, fForce=20000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
