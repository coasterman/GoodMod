...
class GoodModWeapon_JavelinThrow extends AOCWeapon_JavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'GoodModWeaponAttachment_JavelinThrow'
	...
	AlternativeMode=class'GoodModWeapon_JavelinMelee'
