...
*/
class GoodModWeapon_Longsword1H extends AOCWeapon_Longsword1H;
...
DefaultProperties
{
	...
	AttachmentClass=class'GoodModWeaponAttachment_Longsword1H'
	...
	AlternativeMode=class'GoodModWeapon_Longsword'
