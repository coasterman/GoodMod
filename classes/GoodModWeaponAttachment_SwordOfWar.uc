...
*/
class GoodModWeaponAttachment_SwordOfWar extends AOCWeaponAttachment_SwordOfWar;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'GoodModWeapon_SwordOfWar'
	...
	AttackTypeInfo(2)=(fBaseDamage=77.5, fForce=30000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
