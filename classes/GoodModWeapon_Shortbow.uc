...
* Longbow.
*/
class GoodModWeapon_Shortbow extends GoodModWeapon_Longbow
	dependson(AOCPawn);
...
DefaultProperties
{
	 ...
	 */
	ConfigProjectileBaseDamage[0]=(Damage=44,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=45,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=45,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=45,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=0)
	ConfigProjectileBaseDamage[2]=(Damage=10,InitialSpeed=4500.0,MaxSpeed=4500.0,AmmoCount=15,InitialGravityScale=0.6,Drag=0.000004,PitchCorrection=0)
	...
	WindupAnimations(0)=(AnimationName=3p_longbow_draw,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.shortbow_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=0.90,fAnimationLength=0.8,fBlendInTime=0.10,fBlendOutTime=0.00,bLastAnimation=false,bPlayOnWeapon=true,bUseAltNode=true)
