...
class GoodModWeapon_HeavyJavelinThrow extends AOCWeapon_HeavyJavelinThrow;
...
DefaultProperties
{
	...
	AttachmentClass=class'GoodModWeaponAttachment_HeavyJavelinThrow'
	...
	WeaponProjectiles(0)=class'AOCProj_HeavyJavelin'
	WeaponProjectiles(3)=class'AOCProj_HeavyJavelin'
	...
	AlternativeMode=class'GoodModWeapon_HeavyJavelinMelee'
	...
	ConfigProjectileBaseDamage[4]=(Damage=90,InitialSpeed=2600,MaxSpeed=3100,AmmoCount=4,InitialGravityScale=0.85,Drag=0.0000035,PitchCorrection=0)
	...
	WeaponLargePortrait="UI_WeaponImages_SWF.weapon_select_javheavy"
	WeaponSmallPortrait="UI_WeaponImages_SWF.icon_weapon_select_javheavy_png"
	AttackHorizRotateSpeed=75000.0
	SprintAttackHorizRotateSpeed=20000.0
	SprintAttackVerticalRotateSpeed=20000.0
	BattleCryAnim=(AnimationName=3p_javelin_battlecry,ComboAnimation=,AssociatedSoundCue=,bFullBody=true,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=0.0,fAnimationLength=0.0,fBlendInTime=0.10,fBlendOutTime=0.10,bLastAnimation=true)
	WindupAnimations(0)=(AnimationName=3p_javelin_throwwindup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.65,fBlendInTime=0.10,fBlendOutTime=0.10,bLastAnimation=false)
	WindupAnimations(1)=(AnimationName=,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=0.0,fAnimationLength=0.3,fBlendInTime=0.10,fBlendOutTime=0.10,bLastAnimation=false)
	...
	ReleaseAnimations(0)=(AnimationName=3p_javelin_throwrelease,ComboAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_attack_01',bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=0.5,fAnimationLength=0.2,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
	...
	ReleaseAnimations(8)=(AnimationName=3p_javelin_equipup,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.4,fBlendInTime=0.00,fBlendOutTime=0.01,bLastAnimation=false)
	...
	RecoveryAnimations(0)=(AnimationName=3p_javelin_throwrecover,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.0,fBlendInTime=0.00,fBlendOutTime=0.0,bLastAnimation=true)
	...
	RecoveryAnimations(5)=(AnimationName=3p_javelin_shoverecover,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.3,fBlendInTime=0.10,fBlendOutTime=0.0,bLastAnimation=true)
	...
	ReloadAnimations[0]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=0.6,fAnimationLength=.65,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=2)
	ReloadAnimations[1]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=.65,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
	ReloadAnimations[2]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=.65,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
	ReloadAnimations[3]=(AnimationName=3p_javelin_throwreload,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,fModifiedMovement=1.0,fAnimationLength=.65,fBlendInTime=0.0,fBlendOutTime=0.00,bLastAnimation=false,bAttachArrow=1)
	...
	SwapToAnimation=(AnimationName=3p_javelin_stabtothrow,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.5,fBlendInTime=0.10,fBlendOutTime=0.01,bLastAnimation=false)
