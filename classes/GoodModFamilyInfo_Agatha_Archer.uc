class GoodModFamilyInfo_Agatha_Archer extends AOCFamilyInfo_Agatha_Archer;
...
DefaultProperties
{
	...
	NewPrimaryWeapons(3)=(CWeapon=class'GoodModWeapon_Crossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Agatha',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(4)=(CWeapon=class'GoodModWeapon_LightCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Agatha',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(5)=(CWeapon=class'GoodModWeapon_HeavyCrossbow',CForceTertiary=(class'AOCWeapon_PaviseShield_Agatha',class'AOCWeapon_ExtraAmmo'))
	NewPrimaryWeapons(6)=(CWeapon=class'GoodModWeapon_JavelinMelee',CForceTertiary=(class'GoodModWeapon_Buckler_Agatha'))
	NewPrimaryWeapons(7)=(CWeapon=class'GoodModWeapon_ShortSpearMelee',CForceTertiary=(class'GoodModWeapon_Buckler_Agatha'))
	NewPrimaryWeapons(8)=(CWeapon=class'GoodModWeapon_HeavyJavelinMelee',CForceTertiary=(class'GoodModWeapon_Buckler_Agatha'))
	...
	NewTertiaryWeapons(2)=(CWeapon=class'GoodModWeapon_Buckler_Agatha',bEnabledDefault=false)
