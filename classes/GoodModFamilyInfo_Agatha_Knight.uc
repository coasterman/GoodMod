class GoodModFamilyInfo_Agatha_Knight extends AOCFamilyInfo_Agatha_Knight;
...
DefaultProperties
{
	...
	NewTertiaryWeapons(1)=(CWeapon=class'GoodModWeapon_TowerShield_Agatha')
	NewTertiaryWeapons(2)=(CWeapon=class'GoodModWeapon_Heater_Agatha',bEnabledDefault=true)
	NewTertiaryWeapons(3)=(CWeapon=class'GoodModWeapon_Kite_Agatha')
	NewTertiaryWeapons(4)=(CWeapon=class'GoodModWeapon_Buckler_Agatha')
