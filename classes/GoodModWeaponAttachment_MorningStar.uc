...
*/
class GoodModWeaponAttachment_MorningStar extends AOCWeaponAttachment_MorningStar;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'GoodModWeapon_MorningStar'

	WeaponSocket=wep1hpoint
	WeaponStaticMeshScale=1

	AttackTypeInfo(0)=(fBaseDamage=65.0, fForce=20500, cDamageType="AOC.AOCDmgType_PierceBlunt", iWorldHitLenience=6)
