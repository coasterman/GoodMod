...
* Crossbow.
*/
class GoodModWeapon_Crossbow extends GoodModRangeWeapon;
...
DefaultProperties
{
	...
	AttachmentClass=class'GoodModWeaponAttachment_Crossbow'
	...
	WeaponProjectiles(0)=class'GoodModProj_SteelBolt'
