...
*/
class GoodModWeapon_SwordOfWar1H extends AOCWeapon_SwordOfWar1H;
...
DefaultProperties
{
	...
	AttachmentClass=class'GoodModWeaponAttachment_SwordOfWar1H'
	...
	AlternativeMode=class'GoodModWeapon_SwordOfWar'
