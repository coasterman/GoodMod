...
*/
class GoodModWeapon_JavelinMelee extends AOCWeapon_JavelinMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'GoodModWeaponAttachment_Javelin'
	...
	bCanDodge=false
	AlternativeMode=class'GoodModWeapon_JavelinThrow'
	...
	ParryDrain(1)=20
	ParryDrain(2)=10
	WeaponFontSymbol="$"//used to be 'p' but in the UI update this weapon got switched with the spear
	WeaponReach=100
	WeaponLargePortrait="UI_CustWeaponImages_SWF.skin_javelin_png"
	...
	WindupAnimations(1)=(AnimationName=3p_javelin_bashdowntoup,ComboAnimation=,AlternateAnimation=3p_javelin_bashdowntoup,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Jav_Reload',bFullBody=False,bCombo=False,bLoop=False,bForce=false,fModifiedMovement=1.0,fAnimationLength=0.475,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
	...
	RecoveryAnimations(4)=(AnimationName=3p_javelin_parryrecover,ComboAnimation=,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.5,fBlendInTime=0.05,fBlendOutTime=0.1,bLastAnimation=true)
