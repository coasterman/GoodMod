...
*/
class GoodModWeaponAttachment_Halberd extends AOCWeaponAttachment_Halberd;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'GoodModWeapon_Halberd'
	WeaponSocket=wepPolepoint

	AttackTypeInfo(0)=(fBaseDamage=65.0, fForce=34500, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=85.0, fForce=34500, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=75.0, fForce=30175, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
