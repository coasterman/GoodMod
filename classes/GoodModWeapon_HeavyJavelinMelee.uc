...
*/
class GoodModWeapon_HeavyJavelinMelee extends AOCWeapon_HeavyJavelinMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'GoodModWeaponAttachment_HeavyJavelin'
	...
	bCanDodge=false
	AlternativeMode=class'GoodModWeapon_HeavyJavelinThrow'
	...
	RecoveryAnimations(2)=(AnimationName=3p_javelin_stabrecover,ComboAnimation=3p_1hsharp_stabrecover,AssociatedSoundCue=,bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.6,fBlendInTime=0.00,fBlendOutTime=0.0,bLastAnimation=true)
	...
	SwapToAnimation=(AnimationName=3p_javelin_throwtostab,ComboAnimation=,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.jav_draw',bFullBody=false,bCombo=false,bLoop=false,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=1.1,fBlendInTime=0.10,fBlendOutTime=0.10,bLastAnimation=false)
