class GoodModRangeWeapon extends AOCRangeWeapon;
...
simulated function ChangeProjectileType(class<AOCProjectile> Proj) {
	...
	if (class<GoodModWeapon_Crossbow>(Class) != none && AOCOwner.PawnInfo.myTertiary == class'AOCWeapon_ExtraAmmo')
...
simulated state Active {
	simulated function BeginFire(byte FireModeNum) {
		...
		else if (bLoaded || (FireModeNum == Attack_Overhead && GoodModWeapon_Crossbow(self) != none))
