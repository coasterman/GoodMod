...
* Weapon: Smoke Pot
*/
class GoodModWeapon_SmokePot extends AOCWeapon_SmokePot;
...
DefaultProperties
{
	...
	WeaponProjectiles(0)=class'GoodModProj_ThrownSmokePot'
	...
	ConfigProjectileBaseDamage[5]=(Damage=0,InitialSpeed=2000.0,MaxSpeed=2500.0,AmmoCount=3,InitialGravityScale=1.0,Drag=0.000001,PitchCorrection=60.0)
	iFeintStaminaCost=0
	WeaponFontSymbol="*"
	WeaponReach=100
	WeaponLargePortrait="UI_WeaponImages_SWF.weapon_select_smokepot"
	WeaponSmallPortrait="UI_WeaponImages_SWF.icon_weapon_select_smokepot_png"
