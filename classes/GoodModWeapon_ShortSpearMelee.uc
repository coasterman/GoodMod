...
*/
class GoodModWeapon_ShortSpearMelee extends AOCWeapon_ShortSpearMelee;
...
DefaultProperties
{
	...
	AttachmentClass=class'GoodModWeaponAttachment_ShortSpear'
	...
	bCanDodge=false
	AlternativeMode=class'GoodModWeapon_ShortSpearThrow'
